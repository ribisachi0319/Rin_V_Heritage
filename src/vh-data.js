...
window.VH_DATA = {
  ...
  venueInfos: {
    1: {
      ...
      closedDays: 'Thứ Hai hàng tuần',
      ticketPrice: { adult: '40.000đ', child: '20.000đ', note: 'Miễn phí trẻ em < 6 tuổi' },
      phone: '024 3825 2853',
      website: 'baotanglichsu.vn',
      email: 'info@baotanglichsu.vn',
      estimatedVisitDuration: '90 - 120 phút',
    ...
    2: {
      ...
      ticketPrice: { adult: '40.000đ', child: '20.000đ', note: 'Học sinh/Sinh viên giảm 50%' },
      phone: '024 3823 3084',
      website: 'vnfam.vn',
      email: 'info@vnfam.vn',
      estimatedVisitDuration: '60 - 90 phút',
    ...
    3: {
      ...
      closedDays: 'Không nghỉ',
      ticketPrice: { adult: '65.000đ', child: '15.000đ', note: 'Có giảm giá đoàn đông người' },
      phone: '028 3822 3652',
      website: 'dinhdoclap.gov.vn',
      email: 'dinhdoclap@tphcm.gov.vn',
      estimatedVisitDuration: '90 - 120 phút',
    ...
    4: {
      ...
      closedDays: 'Không nghỉ',
      ticketPrice: { adult: 'Miễn phí', child: 'Miễn phí', note: 'Cần mang theo CCCD/Hộ chiếu' },
      phone: '024 3833 0088',
      website: 'ditichk9.gov.vn',
      email: 'vanphong@ditichk9.gov.vn',
      estimatedVisitDuration: '120 - 150 phút',
    ...
    5: {
      ...
      closedDays: 'Không nghỉ',
      ticketPrice: { adult: 'Miễn phí', child: 'Miễn phí', note: 'Tham quan tự do tôn kính' },
      phone: '0233 386 1279',
      website: 'thanhcoquangtri.org',
      email: 'info@thanhcoquangtri.org',
      estimatedVisitDuration: '60 - 90 phút',
      amenities: ['parking', 'guide']
    },
    6: {
      ...
      closedDays: 'Không nghỉ',
      ticketPrice: { adult: '80.000đ', child: 'Miễn phí', note: 'Đã bao gồm 3 điểm tham quan chính' },
      phone: '0235 386 1327',
      website: 'hoianheritage.net',
      email: 'contact@hoianheritage.net',
      estimatedVisitDuration: '120 - 180 phút',
      amenities: ['wifi', 'parking', 'guide', 'shop', 'cafe']
    }
  },
  ...
  deepArticles: {
    1: {
      ...
      blocks: [
        {
          t: 'p',
          text: 'Trống đồng Đông Sơn không đơn thuần là một nhạc khí. Với người Lạc Việt, nó là biểu tượng quyền lực của thủ lĩnh, là vật thiêng trong nghi lễ cầu mưa, cầu mùa, và là chứng tích cho một nền văn minh bản địa rực rỡ phát triển độc lập ở lưu vực sông Hồng.'
        },
        {t: 'h', text: 'Đỉnh cao kỹ thuật luyện kim cổ'},
        {
          t: 'p',
          text: 'Để đúc một chiếc trống lớn liền khối, người thợ Đông Sơn phải làm chủ kỹ thuật khuôn ghép nhiều mang, pha hợp kim đồng – thiếc – chì theo tỷ lệ tính toán để vừa dễ rót vừa cho âm thanh vang. Đây là trình độ mà nhiều nền văn hóa cùng thời chưa đạt tới.'
        },
        {
          t: 'img',
          seed: 'trongdongb',
          cap: 'Mặt trống Ngọc Lũ với ngôi sao nhiều cánh ở trung tâm và các vành hoa văn đồng tâm.'
        },
        {
        ...
        {
          t: 'p',
          text: 'Chính giữa mặt trống là ngôi sao nhiều cánh tượng trưng cho mặt trời — tín ngưỡng thờ thần Mặt Trời của cư dân nông nghiệp. Bao quanh là các vành hoa văn khắc chim Lạc bay, cảnh giã gạo, nhà sàn mái cong, đoàn người hóa trang lông chim nhảy múa: một bức tranh sống động về đời sống vật chất và tinh thần thời dựng nước.'
        },
        {
          t: 'quote',
          text: 'Trống đồng Đông Sơn là pho "sử bằng hình" của người Việt cổ — mỗi vành hoa văn là một trang ghi lại tín ngưỡng, lao động và lễ hội của tổ tiên.',
          who: 'PGS.TS Khảo cổ học, Viện Khảo cổ học Việt Nam'
        },
        {
          t: 'p',
          text: 'Trống được phát hiện năm 1893 khi đắp đê ở Hà Nam, sau thờ tại đình làng Ngọc Lũ và nay là hiện vật trung tâm của Bảo tàng Lịch sử Quốc gia — đại diện loại hình tiêu biểu nhất của văn hóa Đông Sơn trong khu vực Đông Nam Á.'
        },
      ],
    ...
    2: {
      ...
      blocks: [
        {
          t: 'p',
          text: 'Áo tứ thân là trang phục thường nhật và lễ hội của phụ nữ đồng bằng Bắc Bộ từ khoảng thế kỷ XVII–XVIII đến đầu thế kỷ XX. Tên gọi "tứ thân" chỉ bốn vạt áo — hai vạt trước, hai vạt sau — được người xưa gắn với hình ảnh tứ thân phụ mẫu (cha mẹ hai bên).'
        },
        {t: 'h', text: 'Cấu trúc và cách mặc'},
        {
          t: 'p',
          text: 'Áo gồm hai vạt sau may liền sống lưng, hai vạt trước để buông hoặc buộc lại; bên trong mặc yếm đào, thắt lưng bao, đầu vấn khăn mỏ quạ, chân đi guốc mộc. Cách buộc hai vạt trước vừa gọn gàng khi lao động vừa tạo nên dáng thắt eo mềm mại.'
        },
        ...
        {
          t: 'quote',
          text: 'Mỗi chi tiết của áo tứ thân đều mang ý nghĩa: bốn vạt áo nhắc người phụ nữ nhớ công ơn cha mẹ đôi bên, màu nâu non thể hiện nếp sống mộc mạc, tảo tần.',
          who: 'Nhà nghiên cứu trang phục cổ truyền'
        },
        {
          t: 'p',
          text: 'Ngày nay áo tứ thân chủ yếu xuất hiện trong hát quan họ, lễ hội và biểu diễn nghệ thuật, trở thành một biểu tượng thị giác đậm chất Bắc Bộ của văn hóa Việt.'
        },
      ],
    ...
    3: {
      ...
      blocks: [
        {
          t: 'p',
          text: 'Dưới triều Lý, nghệ thuật gốm Đại Việt bước vào thời kỳ rực rỡ. Các lò gốm sản xuất đồ men ngọc, men trắng ngà và hoa nâu phục vụ cung đình và chùa tháp, với hình dáng cân đối và hoa văn lấy cảm hứng từ Phật giáo.'
        },
        {t: 'h', text: 'Bí ẩn của lớp men ngọc'},
        {
          t: 'p',
          text: 'Men ngọc (celadon) có sắc xanh lục nhạt đặc trưng, đạt được nhờ một lượng nhỏ ôxit sắt nung trong môi trường khử ở nhiệt độ cao. Sự đồng đều của lớp men trên xương gốm mịn cho thấy người thợ thời Lý đã kiểm soát rất tốt nhiệt độ và không khí trong lò.'
        },
        ...
        {
          t: 'quote',
          text: 'Hoa sen trên gốm Lý không chỉ là trang trí mà là biểu tượng nhà Phật — sự thanh khiết vươn lên từ bùn lầy, đúng tinh thần của một vương triều sùng đạo.',
          who: 'Chuyên gia gốm cổ, Bảo tàng Lịch sử Quốc gia'
        },
        {
          t: 'p',
          text: 'Gốm men ngọc thời Lý được xem là một trong những đỉnh cao của gốm Việt Nam, đặt nền móng cho truyền thống gốm Đại Việt phát triển liên tục các thế kỷ sau.'
        },
      ],
    ...
    4: {
      ...
      blocks: [
        {
          t: 'p',
          text: 'Thế kỷ XV gắn với cuộc khởi nghĩa Lam Sơn và sự thành lập triều Hậu Lê. Vũ khí thời kỳ này — đặc biệt là kiếm — phản ánh trình độ rèn sắt và quan niệm về chính nghĩa của người Việt trong cuộc kháng chiến chống Minh.'
        },
        {t: 'h', text: 'Nghề rèn và nghệ thuật trang trí'},
        {
          t: 'p',
          text: 'Lưỡi kiếm được rèn từ sắt qua nhiều lần gập – nung – đập để khử tạp chất, tạo độ dẻo và sắc. Chuôi và bao kiếm của tầng lớp quý tộc thường bọc đồng, chạm hình rồng cuộn, sơn then đen bóng — thể hiện vị thế người sở hữu.'
        },
        ...
        {
          t: 'quote',
          text: 'Truyền thuyết Lê Lợi trả gươm cho Rùa Vàng đã nâng thanh kiếm thời Lê từ một binh khí thành biểu tượng văn hóa: chính nghĩa thắng bạo tàn, và hòa bình được trả lại cho dân tộc.',
          who: 'Nhà nghiên cứu lịch sử quân sự'
        },
        {
          t: 'p',
          text: 'Chính vì lớp huyền thoại ấy mà kiếm thời Lê vượt khỏi giá trị một hiện vật khảo cổ, trở thành một phần ký ức cộng đồng gắn với hồ Hoàn Kiếm giữa lòng Hà Nội.'
        },
      ],
    ...
    5: {
      ...
      blocks: [
        {
          t: 'p',
          text: 'Tranh Đông Hồ ra đời ở làng Đông Hồ (Thuận Thành, Bắc Ninh), từng là thú chơi không thể thiếu mỗi dịp Tết của người dân Bắc Bộ. Mỗi bức tranh là một lời chúc: đàn gà, đàn lợn cho sung túc; cá chép, vinh hoa cho con cái đỗ đạt.'
        },
        {t: 'h', text: 'Giấy điệp và màu từ thiên nhiên'},
        {
          t: 'p',
          text: 'Nét độc đáo nằm ở chất liệu: giấy dó được quét lớp hồ trộn bột vỏ sò điệp nghiền mịn, tạo nền óng ánh gọi là giấy điệp. Màu in hoàn toàn từ thiên nhiên — đỏ son từ sỏi, vàng từ hoa hòe, xanh từ lá chàm, đen từ than lá tre, trắng từ vỏ điệp.'
        },
        ...
        {
          t: 'quote',
          text: 'Tranh Đông Hồ là tiếng nói thẩm mỹ của người nông dân: mộc mạc, lạc quan, và thấm đẫm ước mơ về một cuộc sống đủ đầy.',
          who: 'Nghệ nhân làng tranh Đông Hồ'
        },
        {
          t: 'p',
          text: 'Trước nguy cơ mai một, nghề làm tranh Đông Hồ đã được đưa vào danh mục di sản văn hóa phi vật thể cần bảo vệ và đang được lập hồ sơ trình UNESCO ghi danh.'
        },
      ],
    ...
    6: {
      ...
      blocks: [
        {
          t: 'p',
          text: 'Theo văn bia Vạn Phúc thiền tự, năm 1057 vua Lý cho dựng chùa và tháp trên núi Lạn Kha (Phật Tích, Bắc Ninh), tôn trí một pho tượng Phật lớn. Đó chính là tượng A Di Đà ngồi thiền mà ngày nay được công nhận là Bảo vật Quốc gia.'
        },
        {t: 'h', text: 'Vẻ đẹp của sự an nhiên'},
        {
          t: 'p',
          text: 'Tượng tạc Đức Phật ngồi kiết già trên tòa sen, hai tay kết ấn thiền định. Gương mặt phúc hậu, mắt khép hờ, nếp áo cà sa buông mềm như lụa tạc trên đá — diễn tả trạng thái tĩnh tại tuyệt đối, đặc trưng cho phong cách điêu khắc tinh tế thời Lý.'
        },
        {
          t: 'img',
          seed: 'tuongphatb',
          cap: 'Tượng A Di Đà ngồi thiền trên tòa sen, các nếp áo mềm mại tạc trên đá sa thạch.'
        },
        {
          t: 'spec', stitle: 'Thông số hiện vật', items: [
        ...
        {
          t: 'quote',
          text: 'Đây là pho tượng Phật bằng đá lớn nhất và nguyên vẹn nhất còn lại từ thời Lý — một chuẩn mực của nghệ thuật tạo tượng Đại Việt mà các thời sau noi theo.',
          who: 'Chuyên gia mỹ thuật cổ, Cục Di sản Văn hóa'
        },
        {
          t: 'p',
          text: 'Lớp vàng thếp bên ngoài đã mất theo binh lửa và thời gian, chỉ còn lõi đá; nhưng vẻ đẹp tạo hình thì vẫn vẹn nguyên, là niềm tự hào của nghệ thuật điêu khắc Phật giáo Việt Nam.'
        },
      ],
    ...
    7: {
      ...
      blocks: [
        {
          t: 'p',
          text: 'Với các dân tộc Tây Nguyên, cồng chiêng không chỉ là nhạc cụ mà là vật thiêng, là tiếng nói giao tiếp với thần linh (Yàng). Tiếng chiêng hiện diện trong suốt vòng đời con người: lễ thổi tai cho trẻ sơ sinh, mừng lúa mới, mừng nhà rông, cho đến lễ bỏ mả.'
        },
        {t: 'h', text: 'Một dàn nhạc của cộng đồng'},
        {
          t: 'p',
          text: 'Mỗi bộ chiêng gồm nhiều chiếc to nhỏ khác nhau, mỗi người giữ một chiếc đánh một nốt; chỉ khi cả cộng đồng cùng tấu, giai điệu mới hoàn chỉnh. Cách diễn tấu ấy phản ánh tinh thần cố kết cộng đồng đặc trưng của xã hội Tây Nguyên.'
        },
        ...
        {
          t: 'quote',
          text: 'Cồng chiêng là ngôn ngữ thiêng của Tây Nguyên. Mất tiếng chiêng là mất đi sợi dây nối giữa con người, tổ tiên và thần linh.',
          who: 'Nhà nghiên cứu văn hóa dân gian Tây Nguyên'
        },
        {
          t: 'p',
          text: 'Sau Nhã nhạc cung đình Huế, đây là di sản thứ hai của Việt Nam được UNESCO vinh danh, và năm 2008 được chuyển sang Danh sách di sản văn hóa phi vật thể đại diện của nhân loại.'
        },
      ],
    ...
    8: {
      ...
      blocks: [
        {
          t: 'p',
          text: 'Dưới triều Nguyễn (1802–1945), trang phục và mũ mão của quan lại được quy định chặt chẽ theo phẩm hàm. Mỗi loại mũ — cánh chuồn, kim khôi, phốc đầu — gắn với một dịp lễ và một cấp bậc nhất định trong bộ máy triều đình.'
        },
        {t: 'h', text: 'Vàng, đá quý và phẩm hàm'},
        {
          t: 'p',
          text: 'Mũ của các quan đại thần được chế tác công phu: khung kim loại mạ vàng, đính trân châu và đá quý nhiều màu, gắn các hoa văn rồng, mây, hoa lá bằng vàng. Số lượng và loại trang sức trên mũ phản ánh trực tiếp phẩm trật của người đội.'
        },
        ...
        {
          t: 'quote',
          text: 'Trong xã hội quân chủ, một chiếc mũ không bao giờ chỉ là chiếc mũ — nó là tấm "thẻ căn cước" về địa vị, là thứ ngôn ngữ thị giác của trật tự cung đình.',
          who: 'Chuyên gia cổ vật cung đình Huế'
        },
        {
          t: 'p',
          text: 'Những chiếc mũ quan còn lại đến nay là tư liệu quý để nghiên cứu nghề kim hoàn, mỹ thuật trang trí và hệ thống quan chế của triều Nguyễn.'
        },
      ],
  ...
  destVenues: [
    ...
    },
    {
      ...
      y: '50%',
      wheelchair: true,
      floor: 'Lối phẳng, có bậc tam quan'
    },
    {
      id: 17,
      name: 'Địa đạo Củ Chi',
