window.VH_RENDER = {
  ...
  placeVals() {
    ...
    return {
      ...
      venueDownloadText: st._venueDownloadLoading ? ('Đang tải... ' + (st._venueDownloadProgress || 0) + '%') : 'Tải xuống gói dữ liệu',
      venueDownloadProgressW: (st._venueDownloadProgress || 0) + '%',
      showVenueDownloadProgress: !!(st._venueDownloadLoading || st._venueDownloadProgress),
